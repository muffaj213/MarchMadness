...
proj_template <- read_excel(file.path(BRACKET_DIR, "bracket_projection_TEMPLATE.xlsx"), sheet = "Seeds")
...
inst <- read_excel(file.path(BRACKET_DIR, "bracket_projection_TEMPLATE.xlsx"), sheet = "Instructions")
write_xlsx(list(Seeds = proj_filled, Instructions = inst), file.path(BRACKET_DIR, "bracket_projection_2025.xlsx"))
